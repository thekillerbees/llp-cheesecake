	...
	if (confirm(strDeliveryNotice)==true) {
		...
		if (intLocation == null) {
			...
			case 395:
				...
				//Louisville
				strURL = "http://1065.deliverycheckout.com/DirectRestaurantLink.aspx?t=1&r=395";
			...
			case 462:
				...
				//Dadeland
				strURL = "https://www.deliveryandtogo.com/PF8_ViewMenu.asp?RestaurantID=462";
			...
			case 463:
				...
				//Aventura
				strURL = "https://www.deliveryandtogo.com/PF8_ViewMenu.asp?RestaurantID=463";
			...
			case 464:
				...
				//Coco Walk
				strURL = "https://www.deliveryandtogo.com/PF8_ViewMenu.asp?RestaurantID=464";
			...
			case 465:
				...
				//Sawgrass
				strURL = "https://www.deliveryandtogo.com/PF8_ViewMenu.asp?RestaurantID=465";
			...
			case 466:
				...
				//Ft. Laud.
				strURL = "https://www.deliveryandtogo.com/PF8_ViewMenu.asp?RestaurantID=466";
			...
			case 488:
				...
				//West Palm
				strURL = "https://www.deliveryandtogo.com/PF8_ViewMenu.asp?RestaurantID=488";
			...
			case 494:
				...
				//Boca Raton
				strURL = "https://www.deliveryandtogo.com/PF8_ViewMenu.asp?RestaurantID=494";
