...
document.observe('dom:loaded', function () {
	...
	setTimeout(function () {
		console.log("w2gi:iframeHeightUpdated" + "//" + $$('body')[0].scrollHeight + "//" + $$('body')[0].scrollWidth, "*")
		parent.postMessage("w2gi:iframeHeightUpdated" + "//" + $$('body')[0].scrollHeight + "//" + $$('body')[0].scrollWidth, "*");
	}, 10);
