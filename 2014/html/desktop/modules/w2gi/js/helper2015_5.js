...
function search_by_state () {
	...
	if (state_to_search) {
		...
		else if (state_to_search == "Florida") {
			state_to_search = "FL";
		} 
		else if (state_to_search == "California") {
			state_to_search = "CA";
		} 
		else if (state_to_search == "Illinois") {
			state_to_search = "IL";
		} 
		else if (state_to_search == "Indiana") {
			state_to_search = "IN";
		} 
		else if (state_to_search == "Ohio") {
			state_to_search = "OH";
		} 
		else if (state_to_search == "Delaware") {
			state_to_search = "DE";
		} 
		else if (state_to_search == "Georgia") {
			state_to_search = "GA";
		} 
		else if (state_to_search == "Iowa") {
			state_to_search = "IA";
		} 
		else if (state_to_search == "Kansas") {
			state_to_search = "KS";
		} 
		else if (state_to_search == "Virginia") {
			state_to_search = "VA";
		} 
		else if (state_to_search == "Oregon") {
			state_to_search = "OR";
		} 
		else if (state_to_search == "New York") {
			state_to_search = "NY";
		} 
		else if (state_to_search == "Nevada") {
			state_to_search = "NV";
		} 
